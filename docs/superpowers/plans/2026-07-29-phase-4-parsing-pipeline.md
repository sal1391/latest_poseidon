...
- Bare month: "in april" → that month in `reference_date`'s year if start <= reference month else previous year (i.e., most recent occurrence not in the future) — document and pin.
