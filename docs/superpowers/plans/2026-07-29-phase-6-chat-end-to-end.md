...
**Files:** `tests/test_chat_e2e_scripted.py` (pg-marked); `infra/docker-compose.yml` (CHAT_MODE=live for backend); runbook note; Playwright verification (evidence in report, not committed test).
