...
def get_supplier_group_details_query(company_name):
    ...
    SELECT  
        ...
        CONCAT('$', TO_CHAR(ROUND(SUM(CASE WHEN LIFT_YEAR = 2025 THEN TOTAL_GP ELSE 0 END), 0), 'FM999,999,999')) AS "2025 GP",
        ...
        SUM(CASE WHEN LIFT_YEAR = 2024 THEN FIXED_TONS ELSE 0 END) AS "2025 Mtons",
        ...
        SUM(CASE WHEN LIFT_YEAR = 2025 THEN NUMBER_OF_TRANSACTIONS ELSE 0 END) AS "2025 # of Transactions"
    FROM 
...
def get_customer_group_details_query(company_name):
    ...
    SELECT 
        ...
        SUM(CASE WHEN LIFT_YEAR = 2023 THEN FIXED_TONS ELSE 0 END) AS "2023 Mtons",
        SUM(CASE WHEN LIFT_YEAR = 2024 THEN FIXED_TONS ELSE 0 END) AS "2024 Mtons",
        SUM(CASE WHEN LIFT_YEAR = 2025 THEN FIXED_TONS ELSE 0 END) AS "2025 Mtons",
        SUM(CASE WHEN LIFT_YEAR = 2023 THEN NUMBER_OF_TRANSACTIONS ELSE 0 END) AS "2023 # of Transactions",
        SUM(CASE WHEN LIFT_YEAR = 2024 THEN NUMBER_OF_TRANSACTIONS ELSE 0 END) AS "2024 # of Transactions",
        SUM(CASE WHEN LIFT_YEAR = 2025 THEN NUMBER_OF_TRANSACTIONS ELSE 0 END) AS "2025 # of Transactions",
        CONCAT(
        ...
        CONCAT(
            TO_CHAR(
                ROUND(
                    SUM(CASE WHEN LIFT_YEAR = 2025 THEN FIXED_TONS ELSE 0 END) /
                    NULLIF(SUM(CASE WHEN LIFT_YEAR = 2025 THEN PRESENTED_TONS ELSE 0 END), 0) * 100, 2
                ), 'FM999.00'
            ), '%'
        ) AS "2025 Vol Success Rate"
    FROM 
